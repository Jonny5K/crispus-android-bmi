...
public class Einstellungen extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    static final String MAENNLICH = "maennlich";

    /**
     * Einfache Stringkonstante zum auslesen der Preferences.
     */
    static final String WEIBLICH = "weiblich";
     ...
     */
    static final String KEY_GEWICHTBEARBEITEN_ANZAHL = "gewichtbearbeitenAnzahl";
     ...
     */
    public static final SimpleDateFormat SIMPLE_DATE_FORMAT = new SimpleDateFormat("yyyy.MM.dd", Locale.GERMAN);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            findViewById(R.id.buttonPreferencesTitlebar).setVisibility(Button.INVISIBLE);
            addPreferencesFromResource(R.layout.einstellungen);

            getListView().setCacheColorHint(0);

            listPreferences = new ArrayList<>();
     ...
     *
     * @param context Wird verwendet, um den Packagenamen zu erhalten.
     * @return Einstellungen der Anwendung.
     */
    public static SharedPreferences getAnwendungsEinstellungen(final Context context) {
     ...
     */
    @SuppressWarnings("deprecation")
    static void loadLocalInformation(Context context) {
