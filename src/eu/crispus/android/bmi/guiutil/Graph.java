...
public class Graph {
     ...
     *
     * @param gl Zeichenfläche, auf der gezeichnet werden soll.
     */
...
//					gl.glColor4f(1.0f, 0.3f, 0.3f, 1.0f);
     ...
     *
     * @param year Jahr von dem die Anzahl der Tage ermittelt werden soll.
     * @return Liefert die Anzahl der Tage des übergebenen Jahrs zurück.
     */
    private int getDayCountInYear(int year) {
     ...
     *
     * @param characterManager CharacterManager der gesetzt werden soll.
     */
     ...
     *
     * @param datumGewichtArrayList Liste der Einträge die berechnet werden soll.
     */
