...
public class CharacterManager {
     ...
     *
     * @param gl          Zeichenfläche von OpenGL
     * @param str         String der ausgegeben werden soll.
     * @param orientation Ausrichtung (links, rechts, etc.) des Textes.
     * @param colorRed    RGB-Farbanteil von rot.
     * @param colorGreen  RGB-Farbanteil von grün.
     * @param colorBlue   RGB-Farbanteil von blau.
     */
    void paintString(final GL10 gl, final String str, Orientation orientation, float colorRed, float colorGreen, float colorBlue) {
        gl.glPushMatrix();
        {
            int row;
            int column;
     ...
     *
     * @param textureCoords Neue Texture-Koordinaten.
     */
     ...
     *
     * @param bitmap Grafik die geladen werden soll.
     */
     ...
     *
     * @param gl OpenGL-Context auf dem gerendert wird.
     */
