...
public class BMIRechner {
     ...
     */
    static final float KG_TO_POUND = 2.2046f;
     ...
     *
     * @param gewicht Gewicht von dem der BMI berechnet werden soll.
     * @param context Context der Aufrufenden View, wird benötigt um auf die Strings aus der Datei string.xml zuzugreifen.
     ...
     *
     * @param currentBMI aktuell berechneter BMI.
     * @param context    Context der Aufrufenden View, wird benötigt um auf die Strings aus der Datei string.xml zuzugreifen.
     * @return String der angibt, ob der BMI gut oder eher schlecht ist.
     */
    private String getRatingFromBmi(double currentBMI, Context context) {
        try {
     ...
     *
     * @param gewicht        Gewicht von dem der BMI berechnet werden soll.
     * @param koerpergroesse die für die Berechnung genommen wird.
