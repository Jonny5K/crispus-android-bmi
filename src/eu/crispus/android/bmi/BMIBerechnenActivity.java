...
public class BMIBerechnenActivity extends Activity {
     ...
     *
     * @param view RadioButton der gedrückt wurde.
     */
     ...
     * Füllen der Informations-Tabelle und den aktuellen Bereich FETT und Farblich machen
     *
     * @param bereich               Aktueller BMI-Bereich (z.B. Untergewicht), für das angegebene Alter.
     * @param berechneterBMI        Berechneter BMI-Wert, wird benötigt um zu überprüfen ob der Wert im aktuellen BMI-Bereich liegt.
     * @param bmiBerechnenInfoLabel ID der TextView für den aktuellen BMI-Bereich Label.
     * @param bmiBerechnenInfoValue ID der TextView für den aktuellen BMI-Bereich Wert.
     * @param colorCurrent          Farbe für die TextViews, falls sie in dem aktuellen BMI-Bereich liegen.
